...
Gem::Specification.new do |s|
  ...
  s.summary     = "Use FancyBox 2 with Rails 3.1/4.0/5.1"
  s.description = "This gem provides jQuery FancyBox 2 for your Rails 3.1/4.0/5.1 application. This gem is based on the gem for Fancybox 1.x by Chris Mytton"
  s.files       = Dir["{app,lib}/**/*"] + ["MIT-LICENSE", "Rakefile", "Gemfile", "README.md"]
  s.version     = Fancybox2::Rails::VERSION

  s.add_dependency "railties", ">= 3.1.0", "< 5.2.3"
